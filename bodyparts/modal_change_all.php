...
<div>
 ...
 <!-- <div> 
    Порядковый номер КП : $pp
 </div> -->
 <div> 
   <b> Номер КП : <span id="js-new-modal-KpNumber">$KpNumber</span></b>
 </div>
  <div> 
  Дата КП :$KpData
  </div>
  <div> 
  ИНН Заказчика :<span id="js-new-modal-InnCustomer">$InnCustomer</span>
  </div>
  <div> 
 <b>Наименование Заказчика :<span id="js-new-modal-NameCustomer">$NameCustomer</span></b>
  </div>
  <hr>
<div> 
ID  закупки :<span id="js-new-modal-idKp">$idKp</span>
</div>
<hr>
<div> 
Статус КП : <span id="js-new-modal-StatusKp">$StatusKp</span>
</div>
...
<div> 
    <p>Сумма КП  <input type="number" id="KpSum" name="KpSum" value ="$KpSum"></p>
</div>



<div> 
    <p>НМЦК Тендера КП : <span id="js-new-modal-TenderSum">$TenderSum</span></p>
</div>
...
<div> 
  ...
  <textarea id="textarea-Adress" name="Adress" rows="1" cols="50"><span id="js-new-modal-Adress">$Adress</span></textarea>
             ...
             <!-- </table> -->
             <p class="btncommentClass"> SEND</p>                          
          <!-- <p><input class="btncommentClass"  type="submit" value="Отправить"></p> -->
