      ...
      <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
          <thead>
              <tr>
                  ...
                  <th class="text-center">Новых заявок<br>поступило / ожидает</th>
            
                  <th class="text-center">Заявок в работе<br>за период / всего</th>
...
for ($i=0; $i<count($arr_users_active); $i++) {
 ...
 echo <<<HTML
  <tr class="text-center">
                  <td>$user_name</td>
                  <td >
                    <a href="index.php?typeQuery=551&Responsible=$user_name&date_start=$date_start&date_end=$date_end&KpCondition=&FinishContract=">$count_all_new_kp</a>
                    /
