...
$schet_date = date('d') . ' ' . $month_list[date('n')] . ' ' . date('Y'); // 08 сентября 2022
...
//Счет на оплату № ТО-772 от 4 мая 2022 г.
$sheet->setCellValue("F21", 'МБУ "ВЕРХ - ИСЕТСКОЕ ДЭУ", ИНН 6658341748.-Нов');
...
$objWriter = new PHPExcel_Writer_Excel2007($xls);
$objWriter->save(__DIR__ . '/z_file.xlsx');
