...
<h5>ТЕКСТ ПИСЬМА (Можно править все, что угодно, только следить за стилистическими тэгами)</h5>
   ...
   <b>Добрый день!</b> <br> 
    ...
    Если у Вас есть более интересное предложение, то напишите нам, мы постараемся улучшить условия нашего КП. <br><br>
    Стоимость доставки рассчитана ориентировочно и может быть скорректирована.<br><br>
    <br><br>
    С уважением<br>
    ООО ТД АНМАКС<br>
